  ...
  ask patches [
    ...
    if random 100 < density [
      sprout 1 [
        ...
        set display-color color    ; Initialize display-color to match the original color
        set size 1
...
to update-turtles
  ask turtles [
    ...
    set similar-nearby count (turtles-on neighbors) with [original-color = [original-color] of myself]
    set other-nearby count (turtles-on neighbors) with [original-color != [original-color] of myself]
