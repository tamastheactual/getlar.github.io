globals [
  borders?       ;; Flag for whether borders are closed
  initial-actors ;; Tracks the initial number of actors
]
...
to setup
  ...
  (ifelse senario = "base" [
    ...
    ask n-of (count patches with [pcolor = black] * population / 100) patches [
      sprout-actors 1 [
        ...
        set vaccinated? false ;; Default to not vaccinated
      ]
    ]
    vaccinate ;; Vaccinate a proportion of the population
    ask one-of actors with [not vaccinated?] [set color red] ;; Infect one random unvaccinated actor
  ]
  ...
  set initial-actors count turtles
end
...
to cure
  ;; Handle recovery for infected actors after 10 ticks
  if ticks > 10 [
    ask actors with [color = red] [
      if random 100 < cure-rate [
        if random 100 < 50 [set color green] ;; Recovered actors turn green
      ]
    ]
  ]
end
...
"" ""
PENS
"default" 1.0 0 -2139308 true "" "plot count actors with [color = red]"
"pen-1" 1.0 0 -8732573 true "" "plot count actors with [color = green]"
...
senario
senario
"base" "communities" "communities and borders"
2
...
<experiments>
  <experiment name="experiment" repetitions="100" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="number-of-borders">
      <value value="20"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="senario">
      <value value="&quot;communities and borders&quot;"/>
      <value value="&quot;communities&quot;"/>
      <value value="&quot;basic&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="close-when">
      <value value="0.14"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="travel-rate">
      <value value="25"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="close-borders-law">
      <value value="15"/>
    </enumeratedValueSet>
